...
public class ProfileAdapter extends RecyclerView.Adapter<ProfileAdapter.Taskviewholder> {
    ...
    public ProfileAdapter(List<AddTask> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final Taskviewholder holder, final int position) {
        ...
        holder.txtFinishdate.setText(myTask.taskfinishdate);
    }
    ...
    public class Taskviewholder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        TextView txtTaskName, txtTaskDetails, txtDate, txtTime, txtFinishdate;
        ...
        public Taskviewholder(View itemView) {
            ...
            txtFinishdate = itemView.findViewById(R.id.text_finishdate);
